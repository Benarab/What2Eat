...
// Metoderne kommer herunder.
    ...
    private void addIngInList(int opskriftID, Context context) {
        ...
        if (t_ingrediens2.getText().toString() != null || t_mængde2.getText().toString() != null) {
            MainActivity.lokale_ingredienser.add(new Ingredienser(t_ingrediens2.getText().toString(), Integer.parseInt(t_mængde1.getText().toString()) , måleenhedSpinner2.getSelectedItem().toString(), opskriftID));

        }
        if (t_ingrediens3.getText().toString() != null || t_mængde3.getText().toString() != null) {
            MainActivity.lokale_ingredienser.add(new Ingredienser(t_ingrediens3.getText().toString(), Integer.parseInt(t_mængde1.getText().toString()), måleenhedSpinner3.getSelectedItem().toString(), opskriftID));
